...
| v0.6.0 | GitHub Pages 배포 + Cloudflare Workers 프록시 | 예정 |
...
- [ ] **Cloudflare Workers 프록시 배포** (사용자 직접 실행)
...
- [ ] **Google OAuth URL 업데이트**
  ...
  - 승인된 JavaScript 원본에 `https://kkanbi.github.io` 추가

- [ ] **배포 테스트**
  - 브라우저에서 GitHub Pages URL 접속 확인
  - Claude API 동작 확인 (프록시 통해서)
  - Google Drive 로그인 확인
